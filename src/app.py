...
DEFAULT_CONFIG = os.path.join(BASE_DIR, "Results/Dataset/UEA/2025-11-16_12-02/configuration.json")
DEFAULT_CKPT   = os.path.join(BASE_DIR, "Results/Dataset/UEA/2025-11-16_12-02/checkpoints/BasicMotionsmodel_last.pth")
